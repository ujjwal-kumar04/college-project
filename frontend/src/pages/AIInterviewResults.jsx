...
const AIInterviewResults = () => {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(56,189,248,0.15),_transparent_30%)] bg-gray-50 dark:bg-dark-950">
      <div className="max-w-6xl mx-auto px-4 py-6 sm:py-8 space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <button
            onClick={() => navigate('/ai-interview/history')}
            className="inline-flex items-center gap-2 rounded-full border border-gray-300 bg-white/70 px-4 py-2 text-sm font-semibold text-gray-700 shadow-sm backdrop-blur dark:border-dark-700 dark:bg-dark-900/70 dark:text-gray-200"
          >
            <ArrowLeft size={16} />
            Interview history
          </button>
          <div className="rounded-full bg-white/70 px-4 py-2 text-sm font-medium text-gray-600 shadow-sm backdrop-blur dark:bg-dark-900/70 dark:text-gray-300">
        ...
        <motion.section
          ...
          className="rounded-[32px] border border-white/60 bg-white/80 p-6 shadow-panel backdrop-blur dark:border-white/10 dark:bg-dark-900/80"
        >
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-3">
              <div className="rounded-2xl border border-primary-200 bg-primary-50 px-4 py-3 text-sm font-semibold text-primary-700 dark:border-primary-500/20 dark:bg-primary-500/10 dark:text-primary-300">
                Confidence {analysis.confidence}%
              </div>
              <div className="rounded-2xl border border-gray-200 bg-white px-4 py-3 text-sm font-semibold text-gray-700 dark:border-dark-700 dark:bg-dark-850 dark:text-gray-200">
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="rounded-[28px] border border-gray-200 bg-white/85 p-5 dark:border-dark-800 dark:bg-dark-850/85">
              <AIAnalyticsRadar analysis={analysis} />
            </div>

            <div className="rounded-[28px] border border-gray-200 bg-white/85 p-5 dark:border-dark-800 dark:bg-dark-850/85 space-y-5">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <section className="rounded-[30px] border border-white/60 bg-white/80 p-6 shadow-panel backdrop-blur dark:border-white/10 dark:bg-dark-900/80">
        ...
        <section className="rounded-[30px] border border-white/60 bg-white/80 p-6 shadow-panel backdrop-blur dark:border-white/10 dark:bg-dark-900/80">
          ...
          <div className="mt-4 rounded-3xl border border-gray-200 bg-gray-50/80 p-5 leading-7 text-gray-700 dark:border-dark-700 dark:bg-dark-850/80 dark:text-gray-200">
        ...
        <section className="rounded-[30px] border border-white/60 bg-white/80 p-6 shadow-panel backdrop-blur dark:border-white/10 dark:bg-dark-900/80">
          ...
          <div className="mt-5 space-y-4">
            {session.answers.map((answer, index) => (
              <div key={`${answer.questionIndex}-${index}`} className="rounded-3xl border border-gray-200 bg-white/85 p-5 dark:border-dark-800 dark:bg-dark-850/85">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div>
                  ...
                  <div className="rounded-full bg-gray-100 px-3 py-1 text-xs font-semibold text-gray-700 dark:bg-dark-800 dark:text-gray-200">
